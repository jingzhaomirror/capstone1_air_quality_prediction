...
### Click [here](https://public.tableau.com/views/airqualitybycity/Dashboard1?:embed=y&:display_count=yes&publish=yes) for an interactive visualization of *'PM2.5 by city'* in **Tableau**
...
## Further Readings
Link to the full report:<br> https://github.com/jingzhaomirror/capstone1_air_quality_prediction/blob/master/final_report_github.ipynb
<br>
